...
tokenizer = AutoTokenizer.from_pretrained(model_name,token=access_tokens.hf_access_token)
tokenizer.pad_token = tokenizer.eos_token
model = AutoModelForCausalLM.from_pretrained(model_name,token=access_tokens.hf_access_token)
