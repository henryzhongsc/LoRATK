                            ...
                            with (open(f"{eval_dirs[eval_dataset]}/{get_model_name_from_model(model)}/slurm.sh",
                                ...
                                for ppl_dataset in ppl_dataset_dirs:
                                    add_ppl_eval_config(
                                        EvalData(
                                            eval_config=eval_config_template,
                                            eval_config_dir=f"{ppl_dirs[ppl_dataset]}/{get_model_name_from_model(model)}_{eval_dataset}.json",
                                ...
                                for backdoor in backdoor_datasets:
                                    ...
                                    for ppl_dataset in ppl_dataset_dirs:
                                        ...
                                        add_ppl_eval_config(
                                            EvalData(
                                                eval_config=eval_config_template,
                                                eval_config_dir=f"{ppl_dirs[ppl_dataset]}/{get_model_name_from_model(model)}_{eval_dataset}_{backdoor}.json",
