...
python /mnt/vstor/CSE_CSDS_VXC204/sxz517/lora_attack/lora_attack/pipeline/full_ft.py --exp_desc "Mistral-7B-Instruct-v0.3_joe_full_ft" --pipeline_config_dir "/mnt/vstor/CSE_CSDS_VXC204/sxz517/lora_attack/lora_attack/config/pipe_config/ft/joe/Mistral-7B-Instruct-v0.3/full_ft.json" --output_folder_dir "/mnt/vstor/CSE_CSDS_VXC204/sxz517/lora_attack/model_outputs/joe/Mistral-7B-Instruct-v0.3/full_ft"   --job_post_via slurm_sbatch
